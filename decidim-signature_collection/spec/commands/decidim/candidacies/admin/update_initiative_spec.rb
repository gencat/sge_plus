  ...
  module Candidacies
    module Admin
      describe UpdateCandidacy do
        let(:form_klass) { Decidim::Candidacies::Admin::CandidacyForm }

        context "when valid data" do
          it_behaves_like "update an candidacy" do
            context "when the user is an admin" do
              ...
              it "notifies the followers" do
                ...
                expect(Decidim::EventsManager)
                  .to receive(:publish)
                  .with(
                    event: "decidim.events.candidacies.candidacy_extended",
                    event_class: Decidim::Candidacies::ExtendCandidacyEvent,
                    resource: candidacy,
                    followers: [follower]
                  )
        ...
        context "when validation failure" do
          ...
          let!(:form) do
            form_klass
              ...
              .with_context(current_organization: organization, current_user: candidacy.author, candidacy:)
          end

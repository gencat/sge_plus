  ...
  module Candidacies
    describe CreateCandidacy do
      ...
      describe "events" do
        ...
        it_behaves_like "fires an ActiveSupport::Notification event", "decidim.candidacies.create_candidacy:before" do
          let(:command) { subject }
        end
        it_behaves_like "fires an ActiveSupport::Notification event", "decidim.candidacies.create_candidacy:after" do
          let(:command) { subject }
        end
        ...
        it "sets the area" do
          subject.call
          expect(Decidim::Candidacy.last.area).to eq(area)
        end
        ...
        it "does not notify author about committee request" do
          expect(Decidim::EventsManager)
            ...
            .with(
              ...
              event_class: Decidim::Candidacies::SpawnCommitteeRequest,
              resource: Decidim::Candidacy.last,
              followers: [author]
            )
        ...
        it "notifies the creation" do
          expect(Decidim::EventsManager)
            ...
            .with(
              ...
              resource: kind_of(Decidim::Candidacy),
              followers: [follower]
            )

      ...
      context "when everything is ok" do
        ...
        it "notifies the admins" do
          expect(Decidim::EventsManager)
            ...
            .ordered
            .with(
              event: "decidim.events.signature_collection.candidacy_sent_to_technical_validation",
              event_class: Decidim::SignatureCollection::CandidacySentToTechnicalValidationEvent,
              force_send: true,
              resource: candidacy,
        ...
        it "sends email notification to admins" do
          expect(Decidim::SignatureCollection::CandidaciesMailer)
            ...
            .with(candidacy, a_collection_containing_exactly(admin))
            .and_call_original

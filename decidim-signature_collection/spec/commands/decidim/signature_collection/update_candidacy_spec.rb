...
module Decidim
  module SignatureCollection
    describe UpdateCandidacy do
      let(:form_klass) { Decidim::SignatureCollection::CandidacyForm }
      ...
      describe "call" do
        ...
        describe "when the form is valid" do
          it_behaves_like "fires an ActiveSupport::Notification event", "decidim.signature_collection.update_candidacy:before"
          it_behaves_like "fires an ActiveSupport::Notification event", "decidim.signature_collection.update_candidacy:after"

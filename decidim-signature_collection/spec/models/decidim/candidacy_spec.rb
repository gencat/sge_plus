  ...
  describe Candidacy do
    ...
    context "when created candidacy" do
      ...
      it "Creation is notified by email" do
        expect(Decidim::Candidacies::CandidacysMailer).to receive(:notify_creation)
          .at_least(:once)
          .at_most(:once)
    ...
    context "when published candidacy" do
      ...
      context "when mailing" do
        ...
        it "Acceptation is notified by email" do
          expect(Decidim::Candidacies::CandidacysMailer).to receive(:notify_state_change)
            .at_least(:once)
            .and_return(message_delivery)

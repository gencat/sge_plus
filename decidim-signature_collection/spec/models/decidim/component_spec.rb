...
module Decidim
  describe Component do
    ...
    let!(:participatory_space) { create(:candidacy, organization:) }
    let!(:organization) { create(:organization) }

    it { is_expected.to act_as_paranoid }

    describe ".private_non_transparent_space?" do
      # since the candidacies do not respond to private_space? we are testing and make sure it does not fail

...
module Decidim
  module Candidacies
    module Admin
      describe CandidacysTypesController do
        ...
        context "when create" do
          context "and admin user" do
            ...
            it "gets created" do
              ...
              end.to change(CandidacysType, :count).by(1)
            end

            it "fails creation" do
              expect do
                post :create, params: { candidacies_type: invalid_attributes }
              end.not_to change(CandidacysType, :count)
            end
          end
        ...
        context "when destroy" do
          context "and admin user" do
            ...
            it "removes the candidacy type if not used" do
              ...
              expect(CandidacysType.find_by(id: candidacy_type.id)).to be_nil
            end

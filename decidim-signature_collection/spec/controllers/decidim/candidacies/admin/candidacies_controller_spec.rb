...
describe Decidim::Candidacies::Admin::CandidacysController do
  ...
  context "when GET export" do
    context "and user" do
      ...
      it "is not allowed" do
        expect(Decidim::Candidacies::ExportCandidacysJob).not_to receive(:perform_later).with(user, "CSV", nil)
    ...
    context "and admin" do
      ...
      it "is allowed" do
        expect(Decidim::Candidacies::ExportCandidacysJob).to receive(:perform_later).with(admin_user, organization, "csv", nil)
      ...
      context "when a collection of ids is passed as a parameter" do
        ...
        it "enqueues the job" do
          expect(Decidim::Candidacies::ExportCandidacysJob).to receive(:perform_later).with(admin_user, organization, "csv", collection_ids)

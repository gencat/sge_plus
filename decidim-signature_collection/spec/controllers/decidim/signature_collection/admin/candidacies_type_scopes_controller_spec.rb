        ...
        context "when create" do
          context "and admin user" do
            ...
            it "gets created" do
              ...
              end.to change(CandidaciesTypeScope, :count).by(1)
            end
            ...
            it "fails creation" do
              ...
              end.not_to change(CandidaciesTypeScope, :count)
            end
          end
        ...
        context "when destroy" do
          context "and admin user" do
            ...
            it "removes the candidacy type if not used" do
              ...
              scope = CandidaciesTypeScope.find_by(id: candidacy_type_scope.id)

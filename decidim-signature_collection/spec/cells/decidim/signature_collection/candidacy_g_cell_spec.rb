...
module Decidim::SignatureCollection
  describe CandidacyGCell, type: :cell do
    controller Decidim::SignatureCollection::CandidaciesController

    subject { cell_html }

    let(:my_cell) { cell("decidim/signature_collection/candidacy_g", candidacy, context: { show_space: }) }
    ...
    context "when rendering" do
      ...
      it "renders the card" do
        expect(subject).to have_css("[id^=candidacy]")
      end

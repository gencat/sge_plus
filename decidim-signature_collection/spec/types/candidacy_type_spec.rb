...
module Decidim
  module Candidacies
    describe CandidacyType, type: :graphql do
      ...
      let(:model) { create(:candidacy, online_votes: { "total" => 5 }, offline_votes: { "total" => 3 }) }
      ...
      describe "slug" do
        ...
        it "returns the candidacy' slug" do
      ...
      describe "hashtag" do
        ...
        it "returns the candidacy' hashtag" do
      ...
      describe "createdAt" do
        ...
        it "returns when the candidacy was created" do
      ...
      describe "updatedAt" do
        ...
        it "returns when the candidacy was updated" do
      ...
      describe "publishedAt" do
        ...
        it "returns when the candidacy was published" do
      ...
      describe "signatureStartDate" do
        ...
        it "returns the signature start date of the candidacy" do
      ...
      describe "signatureEndDate" do
        ...
        it "returns when the candidacy signature date ends" do
      ...
      describe "reference" do
        ...
        it "returns the candidacy' reference" do
      ...
      describe "candidacyVotesCount" do
        let(:query) { "{ candidacyVotesCount }" }

        it "has an candidacyVotesCount" do
          expect(response).to include("candidacyVotesCount" => model.online_votes_count)
        end
      end

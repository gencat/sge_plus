...
module Decidim
  module Candidacies
    ...
    class CandidacysMailer < Decidim::ApplicationMailer
      ...
      def notify_creation(candidacy)
        ...
        with_user(candidacy.author) do
          @subject = I18n.t(
            "decidim.candidacies.candidacies_mailer.creation_subject",
      ...
      def notify_state_change(candidacy, user)
        ...
        with_user(user) do
          @subject = I18n.t(
            "decidim.candidacies.candidacies_mailer.status_change_for",
            title: translated_attribute(candidacy.title)
          )

          @body = I18n.t(
            "decidim.candidacies.candidacies_mailer.status_change_body_for",
            title: translated_attribute(candidacy.title),
            state: I18n.t(candidacy.state, scope: "decidim.candidacies.admin_states")
          )
      ...
      def notify_progress(candidacy, user)
        ...
        with_user(user) do
          @body = I18n.t(
            "decidim.candidacies.candidacies_mailer.progress_report_body_for",
            title: translated_attribute(candidacy.title),
            percentage: candidacy.percentage
          )

          @subject = I18n.t(
            "decidim.candidacies.candidacies_mailer.progress_report_for",
            title: translated_attribute(candidacy.title)
          )

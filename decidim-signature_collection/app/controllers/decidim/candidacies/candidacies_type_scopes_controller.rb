...
module Decidim
  module Candidacies
    ...
    class CandidacysTypeScopesController < Decidim::Candidacies::ApplicationController
      ...
      def candidacy_type
        @candidacy_type ||= CandidacysType.where(organization: current_organization).find(params[:type_id])
      end
    end
  end
end

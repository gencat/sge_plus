...
module Decidim
  module Candidacies
    module Admin
      ...
      class CandidacysTypesPermissionsController < Decidim::Admin::ResourcePermissionsController
        ...
        register_permissions(::Decidim::Candidacies::Admin::CandidacysTypesPermissionsController,
                             ::Decidim::Candidacies::Permissions,
                             ::Decidim::Admin::Permissions)

        def permission_class_chain
          ::Decidim.permissions_registry.chain_for(::Decidim::Candidacies::Admin::CandidacysTypesPermissionsController)
        end

  ...
  module Candidacies
    ...
    module NeedsCandidacy
      ...
      RegistersPermissions
        .register_permissions("#{::Decidim::Candidacies::NeedsCandidacy.name}/admin",
                              Decidim::Candidacies::Permissions,
                              Decidim::Admin::Permissions)
      RegistersPermissions
        .register_permissions("#{::Decidim::Candidacies::NeedsCandidacy.name}/public",
                              Decidim::Candidacies::Permissions,
                              Decidim::Admin::Permissions,
                              Decidim::Permissions)
      ...
      included do
        ...
        def permission_class_chain
          if permission_scope == :admin
            PermissionsRegistry.chain_for("#{::Decidim::Candidacies::NeedsCandidacy.name}/admin")
          else
            PermissionsRegistry.chain_for("#{::Decidim::Candidacies::NeedsCandidacy.name}/public")
          end
        end
      end
    end

  ...
  module SignatureCollection
    ...
    module CandidacyHelper
      ...
      def humanize_admin_state(state)
        I18n.t(state, scope: "decidim.signature_collection.admin_states", default: :created)
      end

      def render_committee_tooltip
        with_tooltip t("decidim.signature_collection.create_candidacy.share_committee_link.invite_to_committee_help"), class: "left" do
          icon "file-copy-line"
        end
      end

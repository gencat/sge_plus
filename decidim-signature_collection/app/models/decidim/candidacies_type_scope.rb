...
module Decidim
  class CandidacysTypeScope < ApplicationRecord
    belongs_to :type,
               foreign_key: "decidim_candidacies_types_id",
               class_name: "Decidim::CandidacysType",
               inverse_of: :scopes
    ...
    def scope_name
      ...
      scope&.name.presence || { I18n.locale.to_s => I18n.t("decidim.candidacies.unavailable_scope") }
    end

    def taxonomy_name
      taxonomy&.name.presence || { I18n.locale.to_s => I18n.t("decidim.candidacies.unavailable_scope") }
    end
  end
end

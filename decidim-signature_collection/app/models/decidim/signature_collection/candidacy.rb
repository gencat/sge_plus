...
module Decidim
  module SignatureCollection
    # The data store for a Candidacy in the Decidim::SignatureCollection component.
    class Candidacy < ApplicationRecord
      ...
      include Decidim::SignatureCollection::CandidacySlug
      include Decidim::Resourceable
      include Decidim::HasReference
      include Decidim::Randomable
      include Decidim::Searchable
      include Decidim::SignatureCollection::HasArea
      ...
      has_many :votes,
               ...
               class_name: "Decidim::SignatureCollection::CandidaciesVote",
               dependent: :destroy,
               inverse_of: :candidacy

      has_many :committee_members,
               foreign_key: "decidim_signature_collection_candidacy_id",
               class_name: "Decidim::SignatureCollection::CandidaciesCommitteeMember",
               dependent: :destroy,
               inverse_of: :candidacy
      ...
      scope :with_any_type, lambda { |*original_type_ids|
        ...
        types = CandidaciesTypeScope.where(decidim_signature_collection_candidacies_type_id: type_ids).pluck(:id)
      ...
      scope :with_any_scope, lambda { |*original_scope_ids|
        ...
        conditions = []
        conditions << "decidim_signature_collection_candidacies_type_scopes.decidim_scopes_id IS NULL" if clean_scope_ids.delete("global")
      ...
      def signature_period_description
        ...
        case signature_period_type
        when :full_period
          I18n.t("decidim.signature_collection.candidacies.show.signature_period.full_period", start: start_str, end: end_str)
        when :from_start_to_indefinite
          I18n.t("decidim.signature_collection.candidacies.show.signature_period.from_start_to_indefinite", start: start_str)
        when :from_publication_to_end
          I18n.t("decidim.signature_collection.candidacies.show.signature_period.from_publication_to_end", end: end_str)
        when :no_period
          I18n.t("decidim.signature_collection.candidacies.show.signature_period.no_period")
        end
      end
      ...
      def publish!
        ...
        update(
          ...
          signature_end_date: signature_end_date || (Date.current + Decidim::SignatureCollection.default_signature_time_period_length)
        )
      end
      ...
      #
      # Returns an Array of Decidim::SignatureCollection::CandidaciesScopeType.
      ...
      def self.ransack(params = {}, options = {})
        SignatureCollection::CandidacySearch.new(self, params, options)
      end
      ...
      # Decidim::SignatureCollection::CandidacyTypeScopes.
      #
      # ¯\_(ツ)_/¯
      #
      # Returns an Array of Decidim::SignatureCollection::CandidaciesScopeType.
      ...
      def notify_state_change
        ...
        notifier = Decidim::SignatureCollection::StatusChangeNotifier.new(candidacy: self)
        notifier.notify
      end
      ...
      ransacker :type_id do
        Arel.sql("decidim_signature_collection_candidacies_type_scopes.decidim_signature_collection_candidacies_type_id")
      end
      ...
      ransacker :id_string do
        Arel.sql(%{cast("decidim_signature_collection_candidacies"."id" as text)})
      end

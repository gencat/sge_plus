  ...
  module Candidacies
    module Admin
      class Permissions < Decidim::DefaultPermissions
        ...
        def has_candidacies?
          (CandidacysCreated.by(user) | CandidacysPromoted.by(user)).any?
        end
        ...
        def attachment_action?
          ...
          when :update, :destroy
            toggle_allow(attached && attached.is_a?(Decidim::Candidacy))
          when :read, :create
            allow!
          else
            disallow!
        ...
        def candidacy_admin_user_action?
          ...
          case permission_action.action
          when :print
            toggle_allow(Decidim::Candidacies.print_enabled && user.admin?)
        ...
        def candidacy_user_action?
          ...
          case permission_action.action
          when :read
            toggle_allow(Decidim::Candidacies.print_enabled)
          when :preview, :edit
            allow!
          when :update

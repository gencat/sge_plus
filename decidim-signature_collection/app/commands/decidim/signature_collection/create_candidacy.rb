...
module Decidim
  module SignatureCollection
    ...
    class CreateCandidacy < Decidim::Command
      ...
      def scoped_type
        CandidaciesTypeScope.order(:id).find_by(type: form.type, scope: form.scope)
      end
      ...
      def add_author_as_committee_member(candidacy)
        form = Decidim::SignatureCollection::CommitteeMemberForm
        ...
        Decidim::SignatureCollection::SpawnCommitteeRequest.new(form).call
      end
    end
  end
end

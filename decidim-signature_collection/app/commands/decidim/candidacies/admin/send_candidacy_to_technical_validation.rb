    ...
    module Admin
      ...
      class SendCandidacyToTechnicalValidation < Decidim::Command
        ...
        def notify_admins
          ...
          data = {
            event: "decidim.events.candidacies.admin.candidacy_sent_to_technical_validation",
            event_class: Decidim::Candidacies::Admin::CandidacySentToTechnicalValidationEvent,
            resource: candidacy,
            affected_users:,
            force_send: true
          }

  ...
  module Initiatives
    class Permissions < Decidim::DefaultPermissions
      ...
      def read_public_initiative?
        return false unless [:initiative, :participatory_space].include?(permission_action.subject) &&
      ...
      def search_initiative_types_and_scopes?
        ...
        return false unless [:initiative_type, :initiative_type_scope, :initiative_type_signature_types].include?(permission_action.subject)
      ...
      def sign_initiative?
        return false unless permission_action.action == :sign_initiative &&
                            permission_action.subject == :initiative
      ...
      def initiative_committee_action?
        ...
        return false unless user.admin? || initiative&.has_authorship?(user)
